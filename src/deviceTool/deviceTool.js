/**
 * @typedef {import("../nodeTool/nodeTool.types.d.ts").NodeType} NodeType
 * @typedef {import("../nodeTool/nodeTool.types.d.ts").DocumentType} DocumentType
 */
/**
...
/**
 * Goes full screen.
 * @param {HTMLElement | any} node - The node to go full screen.
 */
